...
namespace infinitum\inc\theme\integrations\beaver_builder;

class Beaver_Builder extends \infinitum\inc\theme\integrations\Integration {
    /**
	...
	public function fl_builder_custom_fields($fields) {
	...
	public function fl_builder_render_css($css, $nodes, $global_settings) {
	...
	public function fl_builder_settings_form_defaults($defaults, $form_type) {
	...
	public function fl_builder_ui_enqueue_scripts() {
	...
	public function fl_builder_ui_js_config($config = array()) {
	...
	protected function set_hooks() {
		add_filter('fl_builder_custom_fields', array($this, 'fl_builder_custom_fields'));
		add_filter('fl_builder_register_settings_form', array($this, 'fl_builder_register_settings_form'), 10, 2);
		add_filter('fl_builder_render_css', array($this, 'fl_builder_render_css'), 10, 3);
		add_filter('fl_builder_settings_form_defaults', array($this, 'fl_builder_settings_form_defaults'), 10, 2);
		add_action('fl_builder_ui_enqueue_scripts', array($this, 'fl_builder_ui_enqueue_scripts'));
		add_filter('fl_builder_ui_js_config', array($this, 'fl_builder_ui_js_config'));
